...
public class CanTransitionTests_T1_T2
{
    ...
    [Fact]
    public async Task CanTransition_T1_T2_WhenFromParameterizedState_ShouldReturnTrue()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
    ...
    [Fact]
    public async Task CanTransition_T1_T2_WhenPreWhenConditionOnNextIsTrue_ShouldReturnTrue()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithParameters<int, string>().If((i, s) => i > 0 && s.Length > 0).To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string>())
            .Build();
    ...
    [Fact]
    public async Task CanTransition_T1_T2_WhenPreWhenConditionOnNextIsFalse_ShouldReturnFalse()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
            ...
            .WithState(
                ...
                state =>
                    state
                        .WithParameter<int>()
                        .WithTransition("To B", t => t.WithParameters<int, string>().If((i, _) => i < 0).To("B"))
            )
            .WithState("B", state => state.WithParameters<int, string>())
            .Build();
