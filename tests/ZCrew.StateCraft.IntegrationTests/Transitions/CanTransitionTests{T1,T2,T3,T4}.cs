...
public class CanTransitionTests_T1_T2_T3_T4
{
    ...
    [Fact]
    public async Task CanTransition_T1_T2_T3_T4_WhenFromParameterizedState_ShouldReturnTrue()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
    ...
    [Fact]
    public async Task CanTransition_T1_T2_T3_T4_WhenPreWhenConditionOnNextIsTrue_ShouldReturnTrue()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
    ...
    [Fact]
    public async Task CanTransition_T1_T2_T3_T4_WhenPreWhenConditionOnNextIsFalse_ShouldReturnFalse()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithParameters<int, string, bool, double>().If((i, _, _, _) => i < 0).To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string, bool, double>())
            .Build();
