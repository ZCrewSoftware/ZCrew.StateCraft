                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool>(
                                        (Func<int, string, CancellationToken, Task<(int, string, bool)>>)(
                                            async (a, b, _) => await Task.FromResult((a * 2, b + "!", a < 0))
                                        )
                                    )
                                    .To("B")
                        )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool>(
                                        (Func<int, string, CancellationToken, ValueTask<(int, string, bool)>>)(
                                            (a, b, _) => new ValueTask<(int, string, bool)>((a * 2, b + "!", a < 0))
                                        )
                                    )
                                    .To("B")
                        )
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "Loop",
                            t => t.WithMappedParameters<int, string, bool>((a, b) => (a, b, a > 0)).ToSameState()
                        )
            )
