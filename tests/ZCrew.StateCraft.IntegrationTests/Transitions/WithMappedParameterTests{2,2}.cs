...
public class WithMappedParameterTests_2_2
{
    [Fact]
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithMappedParameters<int, string>((a, b) => (a * 2, b + "!")).To("B")
                        )
            )
    ...
    {
        // Arrange
        var mappingFunction = Substitute.For<Func<int, string, (int, string)>>();
        mappingFunction
            .Invoke(Arg.Any<int>(), Arg.Any<string>())
            .Returns(x => (x.ArgAt<int>(0) * 2, x.ArgAt<string>(1) + "!"));
    ...
    public async Task Transition_WithMappedParameter_ShouldTransformParameter()
    {
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithMappedParameters<int, string>((a, b) => (a + 10, b + " world")).To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string>().OnEntry(onEntry))
            .Build();
        ...
        // Assert
        onEntry.Received(1).Invoke(52, "hello world");
    }
    ...
    public async Task Transition_WithMappedParameter_ShouldCallOnStateChangeForNextStateWithMappedParameter()
    {
        ...
        // Assert
        onStateChange.Received(1).Invoke("A", "To B", "B", 84, "hello!");
    }
    ...
    public async Task Transition_WithMappedParameter_ShouldCallActionWithMappedParameter()
    {
        ...
        // Assert
        invoke.Received(1).Invoke(84, "hello!");
    }
    ...
    public async Task Transition_WithMappedParameter_ShouldCallMethodsInCorrectOrder()
    {
        ...
        Received.InOrder(() =>
        {
            ...
            onStateChangeState.Received(1).Invoke("A", "To B", "B", 84, "hello!");
            onEntry.Received(1).Invoke(84, "hello!");
            invoke.Received(1).Invoke(84, "hello!");
        });
    }
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t =>
                                t.WithMappedParameters<int, string>((a, b) => (a * 2, b + "!"))
                                    .If((_, _) => true)
                                    .To("B")
                        )
            )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.If((_, _) => true)
                                    .WithMappedParameters<int, string>((a, b) => (a * 2, b + "!"))
                                    .To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string>())
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t =>
                                t.WithMappedParameters<int, string>(
                                        (Func<int, string, CancellationToken, Task<(int, string)>>)(
                                            async (a, b, _) => await Task.FromResult((a * 2, b + "!"))
                                        )
                                    )
                                    .To("B")
                        )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string>(
                                        (Func<int, string, CancellationToken, ValueTask<(int, string)>>)(
                                            (a, b, _) => new ValueTask<(int, string)>((a * 2, b + "!"))
                                        )
                                    )
                                    .To("B")
                        )
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "Loop",
                            t => t.WithMappedParameters<int, string>((a, b) => (a * 2, b + "!")).ToSameState()
                        )
            )
            .Build();
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string>((a, b) => (a * 2, b + "!"))
                                    .If((_, _, _) => new ValueTask<bool>(true))
                                    .To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string>())
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string>((a, b) => (a * 2, b + "!"))
                                    .If((_, _, _) => new ValueTask<bool>(false))
                                    .To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string>())
