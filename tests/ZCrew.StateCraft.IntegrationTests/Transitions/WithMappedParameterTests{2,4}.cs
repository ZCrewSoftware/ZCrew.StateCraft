...
public class WithMappedParameterTests_2_4
{
    [Fact]
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t =>
                                t.WithMappedParameters<int, string, bool, double>((a, b) => (a, b, a > 0, (double)a))
                                    .To("B")
                        )
            )
    ...
    {
        // Arrange
        var mappingFunction = Substitute.For<Func<int, string, (int, string, bool, double)>>();
        mappingFunction
            .Invoke(Arg.Any<int>(), Arg.Any<string>())
            .Returns(x => (x.ArgAt<int>(0), x.ArgAt<string>(1), x.ArgAt<int>(0) > 0, (double)x.ArgAt<int>(0)));
    ...
    public async Task Transition_WithMappedParameter_ShouldTransformParameter()
    {
        ...
        // Assert
        onEntry.Received(1).Invoke(84, "hello!", false, 21.0);
    }
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.If((_, _) => true)
                                    .WithMappedParameters<int, string, bool, double>((a, b) => (a, b, a > 0, (double)a))
                                    .To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string, bool, double>())
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool, double>(
                                        (Func<int, string, CancellationToken, Task<(int, string, bool, double)>>)(
                                            async (a, b, _) =>
                                                await Task.FromResult((a * 2, b + "!", a < 0, (double)a / 2))
                                        )
                                    )
                                    .To("B")
                        )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool, double>(
                                        (Func<int, string, CancellationToken, ValueTask<(int, string, bool, double)>>)(
                                            (a, b, _) =>
                                                new ValueTask<(int, string, bool, double)>(
                                                    (a * 2, b + "!", a < 0, (double)a / 2)
                                                )
                                        )
                                    )
                                    .To("B")
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t =>
                                t.WithMappedParameters<int, string, bool, double>((a, b) => (a, b, true, 3.14))
