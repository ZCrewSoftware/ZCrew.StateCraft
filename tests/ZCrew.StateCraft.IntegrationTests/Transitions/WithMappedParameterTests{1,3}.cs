...
public class WithMappedParameterTests_1_3
{
    [Fact]
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithMappedParameters<int, string, bool>(x => (x, x.ToString(), x > 0)).To("B")
                        )
            )
    ...
    {
        // Arrange
        var mappingFunction = Substitute.For<Func<int, (int, string, bool)>>();
        mappingFunction.Invoke(Arg.Any<int>()).Returns(x => (x.Arg<int>(), x.Arg<int>().ToString(), x.Arg<int>() > 0));
    ...
    public async Task Transition_WithMappedParameters_ShouldTransformParameterType()
    {
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithMappedParameters<int, string, bool>(x => (x, $"value: {x}", x > 0)).To("B")
                        )
            )
        ...
        // Assert
        onEntry.Received(1).Invoke(42, "value: 42", true);
    }
    ...
    public async Task Transition_WithMappedParameters_ShouldTransformParameter()
    {
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithMappedParameters<int, string, bool>(x => (x * 2, x.ToString(), x > 0)).To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string, bool>().OnEntry(onEntry))
            .Build();
        ...
        // Assert
        onEntry.Received(1).Invoke(84, "42", true);
    }
    ...
    public async Task Transition_WithMappedParameters_ShouldCallOnEntryWithMappedParameter()
    {
        ...
        // Assert
        onEntry.Received(1).Invoke(42, "42", true);
    }
    ...
    public async Task Transition_WithMappedParameters_ShouldCallOnStateChangeForNextStateWithMappedParameter()
    {
        ...
        // Assert
        onStateChange.Received(1).Invoke("A", "To B", "B", 42, "42", true);
    }
    ...
    public async Task Transition_WithMappedParameters_ShouldCallActionWithMappedParameter()
    {
        ...
        // Assert
        invoke.Received(1).Invoke(42, "42", true);
    }
    ...
    public async Task Transition_WithMappedParameters_ShouldCallMethodsInCorrectOrder()
    {
        ...
        Received.InOrder(() =>
        {
            ...
            onStateChangeState.Received(1).Invoke("A", "To B", "B", 42, "42", true);
            onEntry.Received(1).Invoke(42, "42", true);
            invoke.Received(1).Invoke(42, "42", true);
        });
    }
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t =>
                                t.WithMappedParameters<int, string, bool>(x => (x, x.ToString(), x > 0))
                                    .If((_, _, _) => true)
                                    .To("B")
                        )
            )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.If(_ => true)
                                    .WithMappedParameters<int, string, bool>(x => (x, x.ToString(), x > 0))
                                    .To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string, bool>())
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t =>
                                t.WithMappedParameters<int, string, bool>(
                                        (Func<int, CancellationToken, Task<(int, string, bool)>>)(
                                            async (x, _) => await Task.FromResult((x * 2, x.ToString(), x > 0))
                                        )
                                    )
                                    .To("B")
                        )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool>(
                                        (Func<int, CancellationToken, ValueTask<(int, string, bool)>>)(
                                            (x, _) => new ValueTask<(int, string, bool)>((x * 2, x.ToString(), x > 0))
                                        )
                                    )
                                    .To("B")
                        )
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "Loop",
                            t => t.WithMappedParameters<int, string, bool>(x => (x, x.ToString(), x > 0)).ToSameState()
                        )
            )
            .WithState("A", state => state.WithParameters<int, string, bool>().OnEntry(onEntry))
            .Build();
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool>(x => (x, x.ToString(), x > 0))
                                    .If((_, _, _, _) => ValueTask.FromResult(true))
                                    .To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string, bool>())
