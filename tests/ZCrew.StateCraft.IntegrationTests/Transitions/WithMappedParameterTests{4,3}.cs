            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithMappedParameters<int, string, bool>((a, b, c, d) => (a, b, c)).To("B")
                        )
            )
            ...
            .WithState(
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t => t.WithMappedParameters<int, string, bool>((a, b, c, d) => (a * 2, b + "!", !c)).To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string, bool>().OnEntry(onEntry))
            .Build();
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            "To B",
                            t =>
                                t.WithMappedParameters<int, string, bool>((a, b, c, d) => (a, b, c))
                                    .If((_, _, _) => true)
                                    .To("B")
                        )
            )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.If((_, _, _, _) => true)
                                    .WithMappedParameters<int, string, bool>((a, b, c, d) => (a, b, c))
                                    .To("B")
                        )
            )
            .WithState("B", state => state.WithParameters<int, string, bool>())
