                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool, double>(
                                        (Func<int, CancellationToken, Task<(int, string, bool, double)>>)(
                                            async (x, _) =>
                                                await Task.FromResult((x * 2, x.ToString(), x > 0, (double)x))
                                        )
                                    )
                                    .To("B")
                        )
                ...
                state =>
                    state
                        ...
                        .WithTransition(
                            ...
                            t =>
                                t.WithMappedParameters<int, string, bool, double>(
                                        (Func<int, CancellationToken, ValueTask<(int, string, bool, double)>>)(
                                            (x, _) =>
