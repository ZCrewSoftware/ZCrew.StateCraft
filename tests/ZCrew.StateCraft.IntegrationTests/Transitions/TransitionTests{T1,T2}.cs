...
public class TransitionTests_T1_T2
{
    [Fact]
    public async Task Transition_T1_T2_WhenCalled_ShouldChangeState()
    {
        // Arrange
    ...
    [Fact]
    public async Task Transition_T1_T2_WhenCalled_ShouldPassParametersToOnEntry()
    {
        // Arrange
    ...
    [Fact]
    public async Task Transition_T1_T2_WhenCalled_ShouldPassParametersToAction()
    {
        // Arrange
    ...
    [Fact]
    public async Task Transition_T1_T2_WhenCalled_ShouldInvokeLifecycleHandlersInOrder()
    {
        // Arrange
        ...
        var stateMachine = StateMachine
            ...
            .WithState(
                "B",
                state =>
                    state.WithParameters<int, string>().OnEntry(onEntry).WithAction(action => action.Invoke(invoke))
            )
            .Build();
    ...
    [Fact]
    public async Task Transition_T1_T2_WhenNotActivated_ShouldThrowInvalidOperationException()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
    ...
    [Fact]
    public async Task Transition_T1_T2_WithCondition_WhenConditionIsTrue_ShouldTransition()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
    ...
    [Fact]
    public async Task Transition_T1_T2_WithCondition_WhenConditionIsFalse_ShouldThrow()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
    ...
    public async Task Transition_T1_T2_WhenFromParameterizedState_ShouldChangeState()
    {
        ...
        var stateMachine = StateMachine
            ...
            .WithState("A", state => state.WithParameter<int>().WithTransition<int, string>("To B", "B"))
            .WithState("B", state => state.WithParameters<int, string>())
            .Build();
    ...
    [Fact]
    public async Task Transition_T1_T2_WithShortcut_WhenCalled_ShouldChangeState()
    {
        // Arrange
        var stateMachine = StateMachine
            .Configure<string, string>()
