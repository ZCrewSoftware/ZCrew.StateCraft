...
public class TryTransitionExceptionTests_T
{
    [Fact]
    public async Task TryTransition_T_WhenOnExitThrowsException_ShouldThrowAndRollback()
    {
        // Arrange
    ...
    [Fact]
    public async Task TryTransition_T_WhenOnExitThrowsExceptionOnce_ShouldRetrySuccessfully()
    {
        // Arrange
        var callCount = 0;
    ...
    [Fact]
    public async Task TryTransition_T_WhenOnExitThrowsExceptionOnce_ShouldTransitionDifferentlySuccessfully()
    {
        // Arrange
        var callCount = 0;
        var onExit = Substitute.For<Action<int>>();
    ...
    [Fact]
    public async Task TryTransition_T_WhenStateMachineOnStateChangeThrowsException_ShouldThrowAndRollback()
    {
        // Arrange
        var exception = new InvalidOperationException("Test exception");
        var stateMachine = StateMachine
    ...
    [Fact]
    public async Task TryTransition_T_WhenStateMachineOnStateChangeThrowsExceptionOnce_ShouldRetrySuccessfully()
    {
        // Arrange
        var callCount = 0;
    ...
    [Fact]
    public async Task TryTransition_T_WhenStateMachineOnStateChangeThrowsExceptionOnce_ShouldTransitionDifferentlySuccessfully()
    {
        // Arrange
        var callCount = 0;
        var onStateChange = Substitute.For<Action<string, string, string>>();
    ...
    [Fact]
    public async Task TryTransition_T_WhenStateOnStateChangeThrowsException_ShouldThrowAndRollback()
    {
        // Arrange
        var exception = new InvalidOperationException("Test exception");
        var stateMachine = StateMachine
    ...
    [Fact]
    public async Task TryTransition_T_WhenStateOnStateChangeThrowsExceptionOnce_ShouldRetrySuccessfully()
    {
        // Arrange
        var callCount = 0;
    ...
    [Fact]
    public async Task TryTransition_T_WhenStateOnStateChangeThrowsExceptionOnce_ShouldTransitionDifferentlySuccessfully()
    {
        // Arrange
        var callCount = 0;
        var onStateChange = Substitute.For<Action<string, string, string, string>>();
    ...
    [Fact]
    public async Task TryTransition_T_WhenOnEntryThrowsExceptionOnce_ShouldRetrySuccessfully()
    {
        // Arrange
        var callCount = 0;
    ...
    [Fact]
    public async Task TryTransition_T_WhenPreviousParameterConditionThrowsException_ShouldThrow()
    {
        // Arrange
        var exception = new InvalidOperationException("Test exception");
        var stateMachine = StateMachine
    ...
    [Fact]
    public async Task TryTransition_T_WhenPreviousParameterConditionThrowsExceptionOnce_ShouldRetrySuccessfully()
    {
        // Arrange
        var callCount = 0;
    ...
    [Fact]
    public async Task TryTransition_T_WhenNextParameterConditionThrowsException_ShouldThrow()
    {
        // Arrange
        var exception = new InvalidOperationException("Test exception");
        var stateMachine = StateMachine
    ...
    [Fact]
    public async Task TryTransition_T_WhenNextParameterConditionThrowsExceptionOnce_ShouldRetrySuccessfully()
    {
        // Arrange
        var callCount = 0;
