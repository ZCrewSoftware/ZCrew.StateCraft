...
public class TransitionExceptionTests
{
    ...
    [Fact]
    public async Task Transition_WhenOnEntryThrowsException_ShouldRollbackAndHaveExpectedProperties()
    {
        // Arrange
        var exception = new InvalidOperationException("Test exception");
        var stateMachine = StateMachine
    ...
    [Fact]
    public async Task Transition_WhenOnEntryThrowsExceptionOnce_ShouldTransitionDifferentlySuccessfully()
    {
        // Arrange
        var callCount = 0;
        var onEntry = Substitute.For<Action>();
    ...
    [Fact]
    public async Task Transition_T_WhenOnEntryThrowsException_ShouldRollbackAndHaveExpectedProperties()
    {
        // Arrange
        var exception = new InvalidOperationException("Test exception");
        var stateMachine = StateMachine
    ...
    [Fact]
    public async Task Transition_T_WhenOnEntryThrowsExceptionOnce_ShouldTransitionDifferentlySuccessfully()
    {
        // Arrange
        var callCount = 0;
        var onEntry = Substitute.For<Action<string>>();
