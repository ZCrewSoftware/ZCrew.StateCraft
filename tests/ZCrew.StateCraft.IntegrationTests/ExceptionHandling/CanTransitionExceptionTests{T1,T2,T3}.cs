...
public class CanTransitionExceptionTests_T1_T2_T3
{
    [Fact]
    public async Task CanTransition_T1_T2_T3_WhenNextParameterConditionThrowsException_ShouldThrow()
    {
        // Arrange
        ...
        var thrownException = await Assert.ThrowsAsync<InvalidOperationException>(() =>
            stateMachine.CanTransition("To B", 42, "hello", true, TestContext.Current.CancellationToken)
        );
    ...
    [Fact]
    public async Task CanTransition_T1_T2_T3_WhenNextParameterConditionThrowsExceptionOnce_ShouldRetrySuccessfully()
    {
        // Arrange
        var callCount = 0;
    ...
    [Fact]
    public async Task CanTransition_T1_T2_T3_WhenNextParameterConditionThrowsExceptionOnce_ShouldCheckDifferentTransitionSuccessfully()
    {
        // Arrange
        var callCount = 0;
        var condition = Substitute.For<Func<int, string, bool, bool>>();
