...
{
    [Fact]
    public void ToPlantUmlDiagram_WhenFromTransitionExcludesNoStates_ShouldRenderEdgeFromEveryState()
    {
        // Arrange
    ...
    [Fact]
    public void ToPlantUmlDiagram_WhenFromTransitionExcludesSomeStates_ShouldSkipExcludedSources()
    {
        // Arrange
        var configuration = StateMachine
            .Configure<string, string>()
    ...
    [Fact]
    public void ToPlantUmlDiagram_WhenFromTransitionExcludesAllStates_ShouldRenderNoEdges()
    {
        // Arrange
        var configuration = StateMachine
            .Configure<string, string>()
        ...
        // Assert
        Assert.Contains("state \"Hub\" as Hub", diagram);
        Assert.DoesNotContain(" --> Hub", diagram);
    }
}
