...
/// <summary>
///     Configuration for the <see cref="RepeatingTrigger{TState,TTransition}"/>.
/// </summary>
    ...
    where TTransition : notnull
{
    ...
    public ITrigger Build(IStateMachine<TState, TTransition> stateMachine)
    {
        ...
        return new RepeatingTrigger<TState, TTransition>(stateMachine, this.configuredSignal, this.configuredTrigger);
    }
