    ...
    where TTransition : notnull
{
    ...
    ///     to the <paramref name="handler"/> are: the previous state, the transition, the next state, and the transition
    ///     parameter.
    ///     </para>
    ///     <para>
    ...
    ///     <para>
    ///     Configures a <paramref name="handler"/> delegate which will be called when the state changes. The parameters
    ///     to the <paramref name="handler"/> are: the previous state, the transition, the next state, the transition
    ...
    /// <param name="to">The target state.</param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IParameterizedStateConfiguration<TState, TTransition, T> WithTransition<T1, T2>(TTransition transition, TState to)
    {
    ...
    /// <param name="to">The target state.</param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IParameterizedStateConfiguration<TState, TTransition, T> WithTransition<T1, T2, T3>(
        TTransition transition,
        TState to
    )
    {
    ...
    /// <param name="to">The target state.</param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IParameterizedStateConfiguration<TState, TTransition, T> WithTransition<T1, T2, T3, T4>(
        TTransition transition,
        TState to
    )
    {
