...
/// <summary>
///     Configures a state with four parameters.
/// </summary>
...
public interface IParameterizedStateConfiguration<TState, TTransition, T1, T2, T3, T4>
    ...
    where TTransition : notnull
{
    ...
    IParameterizedStateConfiguration<TState, TTransition, T1, T2, T3, T4> WithAction(
    ...
    /// <param name="to">The target state.</param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IParameterizedStateConfiguration<TState, TTransition, T1, T2, T3, T4> WithTransition<TNext>(
        TTransition transition,
        TState to
    )
    {
    ...
    /// <param name="to">The target state.</param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IParameterizedStateConfiguration<TState, TTransition, T1, T2, T3, T4> WithTransition<TNext1, TNext2>(
        TTransition transition,
        TState to
    )
    {
    ...
    /// <param name="to">The target state.</param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IParameterizedStateConfiguration<TState, TTransition, T1, T2, T3, T4> WithTransition<TNext1, TNext2, TNext3>(
        TTransition transition,
        TState to
    )
    {
    ...
    IParameterizedStateConfiguration<TState, TTransition, T1, T2, T3, T4> WithTransition<
        ...
        TNext3,
        TNext4
    >(TTransition transition, TState to)
    {
