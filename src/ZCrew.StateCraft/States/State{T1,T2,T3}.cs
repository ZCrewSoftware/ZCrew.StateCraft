    ...
    where TTransition : notnull
{
    ...
    /// <inheritdoc />
    public IReadOnlyList<Type> StateParameterTypes { get; } = [typeof(T1), typeof(T2), typeof(T3)];
    ...
    public async Task Action(IStateMachineParameters parameters, CancellationToken token)
    {
        ...
        {
            await StateMachine.ExceptionBehavior.CallAction(t => action.Invoke(p1, p2, p3, t), token);
        }
    }
