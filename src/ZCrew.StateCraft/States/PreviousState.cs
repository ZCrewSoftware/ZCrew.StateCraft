...
/// <summary>
///     Runtime representation of a two-parameter previous state with its associated conditions.
/// </summary>
/// <typeparam name="TState">
///     The state type. This should be an <see langword="enum"/> type or it should be an equatable type so the state
///     machine behaves as expected.
...
internal class PreviousState<TState, TTransition, T1, T2> : IPreviousState<TState, TTransition>
    where TState : notnull
    where TTransition : notnull
{
    ...
    ///     <see cref="PreviousState{TState, TTransition, T1, T2}"/> class.
    /// </summary>
    /// <param name="state">The state that this previous state references.</param>
    /// <param name="conditions">The parameterized conditions that must be satisfied before transitioning.</param>
...
/// <summary>
///     Runtime representation of a three-parameter previous state with its associated conditions.
/// </summary>
/// <typeparam name="TState">
///     The state type. This should be an <see langword="enum"/> type or it should be an equatable type so the state
///     machine behaves as expected.
...
internal class PreviousState<TState, TTransition, T1, T2, T3> : IPreviousState<TState, TTransition>
    where TState : notnull
    where TTransition : notnull
{
    ...
    /// <summary>
    ///     Initializes a new instance of the
    ///     <see cref="PreviousState{TState, TTransition, T1, T2, T3}"/> class.
    /// </summary>
    /// <param name="state">The state that this previous state references.</param>
    /// <param name="conditions">The parameterized conditions that must be satisfied before transitioning.</param>
...
/// <summary>
///     Runtime representation of a four-parameter previous state with its associated conditions.
/// </summary>
/// <typeparam name="TState">
///     The state type. This should be an <see langword="enum"/> type or it should be an equatable type so the state
///     machine behaves as expected.
...
internal class PreviousState<TState, TTransition, T1, T2, T3, T4> : IPreviousState<TState, TTransition>
    where TState : notnull
    where TTransition : notnull
{
    ...
    /// <summary>
    ///     Initializes a new instance of the
    ///     <see cref="PreviousState{TState, TTransition, T1, T2, T3, T4}"/> class.
    /// </summary>
    /// <param name="state">The state that this previous state references.</param>
    /// <param name="conditions">The parameterized conditions that must be satisfied before transitioning.</param>
