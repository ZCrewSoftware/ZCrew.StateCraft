...
/// <inheritdoc cref="IFromTransitionConfiguration{TState, TTransition, TNext1, TNext2, TNext3, TNext4}"/>
internal class FromTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4>
    : IFromTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4>,
        IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4>
    ...
    where TTransition : notnull
{
    ...
    ///     <see cref="FromTransitionConfiguration{TState, TTransition, TNext1, TNext2, TNext3, TNext4}"/> class.
    /// </summary>
    ...
    /// <inheritdoc />
    public IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4> AllStates()
    {
        return this;
    }

    /// <inheritdoc />
    public IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4> AllOtherStates()
    {
    ...
    /// <inheritdoc />
    public IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4> Except(
        TState state
    )
    {
    ...
    /// <inheritdoc />
    public IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4> Except<TPrevious>(
        TState state
    )
    {
    ...
    /// <inheritdoc />
    public IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4> OnTransition(
