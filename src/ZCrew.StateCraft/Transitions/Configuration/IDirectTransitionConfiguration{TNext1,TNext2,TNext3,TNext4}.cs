...
/// <summary>
///     Configures a four-parameter transition. Conditions added here receive all four transition parameter values
...
///     </para>
/// </remarks>
public interface IDirectTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4>
    ...
    where TTransition : notnull
{
    ...
    ///     The handler receives the transition parameter values that were passed to the next state.
    /// </summary>
    ...
    /// </param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IDirectTransitionConfiguration<TState, TTransition, TNext1, TNext2, TNext3, TNext4> OnTransition(
