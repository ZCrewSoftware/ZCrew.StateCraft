...
/// <summary>
///     Configures a two-parameter transition. Conditions added here receive both transition parameter values
...
///     </para>
/// </remarks>
public interface IDirectTransitionConfiguration<TState, TTransition, TNext1, TNext2>
    ...
    where TTransition : notnull
{
    ...
    /// </param>
    /// <returns>A reference to the configuration after the configuration was updated.</returns>
    IDirectTransitionConfiguration<TState, TTransition, TNext1, TNext2> OnTransition(
