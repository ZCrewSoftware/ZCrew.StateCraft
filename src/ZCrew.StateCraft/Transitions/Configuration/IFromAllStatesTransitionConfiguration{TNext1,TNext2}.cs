...
/// <summary>
///     Configures an inverted transition (whose destination state has two parameters) from all (or most) states,
...
public interface IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2>
    ...
    where TTransition : notnull
{
    ...
    IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2> Except(TState state);

    /// <inheritdoc cref="IFromAllStatesTransitionConfiguration{TState, TTransition}.Except{TPrevious}(TState)"/>
    IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2> Except<TPrevious>(TState state);

    /// <inheritdoc cref="IFromAllStatesTransitionConfiguration{TState, TTransition}.Except{TPrevious1, TPrevious2}(TState)"/>
    IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2> Except<TPrevious1, TPrevious2>(
        TState state
    );

    /// <inheritdoc cref="IFromAllStatesTransitionConfiguration{TState, TTransition}.Except{TPrevious1, TPrevious2, TPrevious3}(TState)"/>
    IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2> Except<
        TPrevious1,
        TPrevious2,
        TPrevious3
    >(TState state);
    ...
    IFromAllStatesTransitionConfiguration<TState, TTransition, TNext1, TNext2> OnTransition(
