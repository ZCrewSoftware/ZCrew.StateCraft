    ...
    where TTransition : notnull
{
    ...
    /// <summary>
    ///     Configures the transition to map the previous parameter of type <typeparamref name="T"/> to two
    ...
    /// <summary>
    ///     Configures the transition to map the previous parameter of type <typeparamref name="T"/> to three
    ///     parameters for the next state.
    /// </summary>
    /// <typeparam name="TNext1">The type of the first parameter for the next state.</typeparam>
    /// <typeparam name="TNext2">The type of the second parameter for the next state.</typeparam>
    ...
    /// <summary>
    ///     Configures the transition to map the previous parameter of type <typeparamref name="T"/> to four
    ///     parameters for the next state.
    /// </summary>
    /// <typeparam name="TNext1">The type of the first parameter for the next state.</typeparam>
    /// <typeparam name="TNext2">The type of the second parameter for the next state.</typeparam>
