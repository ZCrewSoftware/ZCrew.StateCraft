...
{
    private readonly AsyncMapValueTuple4<TIn, TOut1, TOut2, TOut3, TOut4> map;

    public MappingFunctionValueTuple4(AsyncMapValueTuple4<TIn, TOut1, TOut2, TOut3, TOut4> map)
    {
        this.map = map;
    }
...
{
    private readonly AsyncMapValueTuple4<TIn1, TIn2, TOut1, TOut2, TOut3, TOut4> map;

    public MappingFunctionValueTuple4(AsyncMapValueTuple4<TIn1, TIn2, TOut1, TOut2, TOut3, TOut4> map)
    {
        this.map = map;
    }
...
{
    private readonly AsyncMapValueTuple4<TIn1, TIn2, TIn3, TOut1, TOut2, TOut3, TOut4> map;

    public MappingFunctionValueTuple4(AsyncMapValueTuple4<TIn1, TIn2, TIn3, TOut1, TOut2, TOut3, TOut4> map)
    {
        this.map = map;
    }
...
{
    private readonly AsyncMapValueTuple4<TIn1, TIn2, TIn3, TIn4, TOut1, TOut2, TOut3, TOut4> map;

    public MappingFunctionValueTuple4(AsyncMapValueTuple4<TIn1, TIn2, TIn3, TIn4, TOut1, TOut2, TOut3, TOut4> map)
    {
        this.map = map;
    }
