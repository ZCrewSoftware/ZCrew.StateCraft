...
///     the <see cref="IStateMachineParameters.GetCurrentParameter"/> overloads.
/// </summary>
internal interface ICurrentParametersHandler
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="parameters">The state machine parameters to pull the current parameters from.</param>
